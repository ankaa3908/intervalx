...
La variante étoilée permet de composer des intervalles d'entiers, en utilisant le package \pkg{stmaryrd}.\footnote{\href{https://ctan.org/pkg/stmaryrd}{Voir sur \textsc{ctan}}} Toutes les clés citées ci-dessus sont compatibles avec ces symboles.
...
\begin{function}{\ointerval, \linterval, \rinterval}
  \begin{syntax}
    \sarg\marg{open, clés}\marg{bornes}
    \sarg\marg{open left, clés}\marg{bornes}
    \sarg\marg{open right, clés}\marg{bornes}
  \end{syntax}
  Enfin, le package met à disposition des raccourcis à travers ces trois macros:
\end{function}
