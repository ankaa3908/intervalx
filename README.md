...
In addition, an `\ineq` macro is provided to typeset inequalities. Its use is fairly similar to that of `\interval`.
...
intervalx.dtx               The source file, along with the derived files:
- intervalx-doc-en.pdf      The english package documentation in PDF format.
- intervalx-doc-fr.pdf      The french package documentation in PDF format.
```
